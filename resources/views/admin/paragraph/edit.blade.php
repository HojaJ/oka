...
<div class="container-fluid">
    ...
    <div class="col-8 mx-auto">
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route('paragraph.update', $data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="explanation" rows="8" class="textarea_summer form-control" id="exampleE">{{ $data->explanation }}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="exampleT">Translation</label>
                            <textarea name="translation" rows="8" class="textarea_summer form-control" id="exampleT">{{ $data->translation }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="unit_id" id="exampleU" class="form-control">
                                ...
                                @foreach($units as $unit)
                                    <option @if($data->unit_id === $unit->id) selected @endif value="{{$unit->id}}">{{ $unit->name }}</option>
                                @endforeach
                            </select>
                        </div>
